...
class Application:
    ...
    def __init__(self):
        ...
        self.T.config(text="Intelligent Hand Sign Recognition and Linguistic Translation System", font=("Times new roman",28, "bold"))
        ...
        self.T1.config(text="CHARACTER:", font=("TIMES NEW ROMAN", 27))
        ...
        self.T3.config(text="SENTENCE:", font=("TIMES NEW ROMAN", 27))

        self.T4 = tk.Label(self.root)
        self.T4.place(x=10, y=700)
        self.T4.config(text="Suggestions :", fg="red", font=("TIMES NEW ROMAN", 27, "bold"))
        ...
        self.speak = tk.Button(self.root,bg="gray",fg="white")
        self.speak.place(x=1305, y=630)
        self.speak.config(text="Speak", font=("TIMES NEW ROMAN", 20), wraplength=100, command=self.speak_fun)

        self.clear = tk.Button(self.root,bg="gray",fg="white")
        self.clear.place(x=1305, y=550)
    ...
    def video_loop(self):
        try:
            ...
            if hands:
                ...
                white = cv2.imread(r"C:\Users\palla\Downloads\Sign-Language-To-Text-and-Speech-Conversion-master\Sign-Language-To-Text-and-Speech-Conversion-master\white.jpg")
                # img_final=img_final1=img_final2=0
